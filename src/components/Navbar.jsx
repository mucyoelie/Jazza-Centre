      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 pb-6">
          ...
          <div className="flex gap-3 mt-4">
            <Link to="/hire" onClick={() => setOpen(false)} className="flex-1 bg-brand-red text-white py-3 rounded-full font-semibold text-center">Hire a DM</Link>
            <Link to="/enroll" onClick={() => setOpen(false)} className="flex-1 border-2 border-brand-red text-brand-red py-3 rounded-full font-semibold text-center">Enroll</Link>
          </div>
        </div>
      )}
    </nav>
